    ...
    <>
      ...
      <main className="text-xl min-h-screen py-4 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-18 text-center">
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="relative aspect-[7/7] sm:aspect-[5/5] md:aspect-[6/7] lg:aspect-[7/5] w-full">
            <Image
              src={Image1}
          ...
          <div className="flex flex-col justify-center">
            <div className="flex items-center justify-center h-full">
              <div className="text-base sm:text-lg leading-relaxed max-w-md sm:text-center lg:text-start text-center md:text-left">
